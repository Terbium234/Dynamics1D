...
function B_i_Plot({ iteration }) { // iterationをpropsとして受け取る
  const svgRef = useRef();
  const plotWidth = 600;
  ...
  useEffect(() => {
    ...
    if (svgElement) {
      ...
      svgElement.setAttribute('width', plotWidth);
  ...
  return (
    ...
    <div style={{ marginBottom: '10px', border: '1px solid blue', padding: '5px', backgroundColor: '#e0e0ff' }}>
